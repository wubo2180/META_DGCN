...
class GCNGRU(torch.nn.Module):
    ...
    Args:
        ...
        normalization (str, optional): The normalization scheme for the graph
            ...
            You need to pass :obj:`` to the :meth:`forward` method of
            this operator in case the normalization is non-symmetric.
            :obj:`\` should be a :class:`torch.Tensor` of size
            :obj:`[num_graphs]` in a mini-batch scenario and a
            scalar/zero-dimensional tensor when operating on single graphs.
            You can pre-compute :obj:`` via the
    ...
    def forward(
        ...
        Arg types:
            ...
            * **** *(PyTorch Tensor, optional but mandatory if normalization is not sym)* - Largest eigenvalue of Laplacian.
